...
def main():
    ...
    if run_varyflops:
        nvals = [2**(6+x) for x in range(trials_n)]
        configs_t = [(8, 8), (16, 16), (24, 24), (32, 32)]
        run_varyflops_trials(ctx, queue, nvals, configs_t, Atrain, Atest, ytrain, ytest,
    ...
    if run_varyflops or run_axpy or run_tp or run_conv or run_empt or run_fd:
